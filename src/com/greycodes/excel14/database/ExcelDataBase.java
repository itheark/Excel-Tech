...
return flag;
	...
	private class ExcelDatabaseHelper extends SQLiteOpenHelper{
		...
		static final String Create_userdetails = "CREATE TABLE USER (PID INT PRIMARY KEY NOT NULL,FNAME VARCHAR NOT NULL,LNAME VARCHAR NOT NULL,PASSWORD VARCHAR NOT NULL,EMAIL VARCHAR NOT NULL,COLLEGE VARCHAR NOT NULL,DEPT VARCHAR NOT NULL,PHONE VARCHAR NOT NULL,PICTURE BLOB);";
		static final String Create_ts = "CREATE TABLE TALKSERIES (TID INT PRIMARY KEY NOT NULL,INTRO VARCHAR NOT NULL);";
		...
		static final String Create_speakers = "CREATE TABLE SPEAKERS (SID INT PRIMARY KEY NOT NULL,SPEAKER VARCHAR NOT NULL,EVENT VARCHAR NOT NULL);";
			...
			if(sharedPreferences.getBoolean("active",false)){
			    ...
			    .setPositiveButton("Check Again", new DialogInterface.OnClickListener() {
			        public void onClick(DialogInterface dialog, int which) { 
			            context.startService(new Intent(context, ParseActivate.class) );
			        }
			     })
